...
int i;
		...
		if (world.getBlock(x, y, z)== Blocks.nether_brick && world.getBlock(x, y+1 ,z)== Blocks.air) {
			...
			world.setBlock(x-2, y, z+2, Blocks.cobblestone);
			world.setBlock(x, y+5, z+2, Blocks.cobblestone);
			world.setBlock(x, y+1, z+2, magmabeo.Titan_Block);
			//out 1
			//down
			for(int ii=0;ii<y-16;ii++) {
				for(i=-1;i<2;i++) {
					world.setBlock(x+i, y-ii, z+ii+2, Blocks.cobblestone);
					world.setBlock(x+i, y-ii-1, z+ii+2, Blocks.air);//c-a-a-a-c le chemin
					world.setBlock(x+i, y-ii-2, z+ii+2, Blocks.air);
					world.setBlock(x+i, y-ii-3, z+ii+2, Blocks.air);
					world.setBlock(x+i, y-ii-4, z+ii+2, Blocks.cobblestone);
				}
			}
